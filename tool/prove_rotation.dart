...
Future<void> main(List<String> argv) async {
  ...
  final oldPin = Fingerprint.parse(args['old-pin']!);
  final newPin = Fingerprint.parse(args['new-pin']!);
  ...
  _check(s1 is PairingRefused, 'refused', '${s1.runtimeType}');
  _check(
  ...
  _check(overrides.pin == newPin, 'the live pin is the new fingerprint');
  ...
  try {
    ...
    _check(lower.contains('vpn'), 'the message names the likely cause');
    _check(
